            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a 
                  ...
                  className="text-primary-foreground/70 hover:text-secondary transition-all duration-300 flex items-center gap-2 group"
                >
                  <span className="group-hover:translate-x-1 transition-transform duration-300">Starter Pack</span>
                  <ExternalLink className="h-3 w-3 opacity-50" />
                </a>
              </li>
              <li>
                <a 
                  href="https://buy.stripe.com/00w00kf2d0RDfIXcnP7g40j" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-primary-foreground/70 hover:text-secondary transition-all duration-300 flex items-center gap-2 group"
                >
                  <span className="group-hover:translate-x-1 transition-transform duration-300">Advanced Pack</span>
                  <ExternalLink className="h-3 w-3 opacity-50" />
                </a>
              </li>
              <li>
                <a 
                  href="https://buy.stripe.com/5kQbJ22fr57T8gv73v7g40l" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-primary-foreground/70 hover:text-secondary transition-all duration-300 flex items-center gap-2 group"
                >
                  <span className="group-hover:translate-x-1 transition-transform duration-300">Pro Pack</span>
                  <ExternalLink className="h-3 w-3 opacity-50" />
                </a>
              </li>
            </ul>
