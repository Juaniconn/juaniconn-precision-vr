...
export const Warranty = () => {
  return (
    <section id="warranty" className="section-padding bg-card relative overflow-hidden">
      <div className="absolute top-0 left-0 w-96 h-96 bg-secondary/10 rounded-full blur-[150px]" />
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          <span className="text-sm font-semibold text-primary tracking-widest uppercase mb-4 block">Garantía</span>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-display">CONFIANZA EN <span className="text-primary">CADA PRODUCTO</span></h2>
        </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1 space-y-4">
                ...
                <p className="text-foreground/90 leading-relaxed">
                  Todos nuestros productos Beekonz cuentan con 90 días de garantía a partir de la fecha de entrega. Durante este periodo, cualquier falla de fabricación será reparada o reemplazada sin costo adicional.
                </p>
                <p className="text-foreground/90 leading-relaxed">
