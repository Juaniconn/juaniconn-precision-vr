...
const FAQPage = () => {
  const faqs = [
    { 
      ...
      a: "Sí, completamente compatible. Nuestros trackers utilizan el protocolo nativo de SlimeVR." 
    },
    { 
      q: "¿Cuánto dura la batería?", 
      a: "Más de 50 horas por carga completa. Puedes jugar varios días sin necesidad de recargar." 
    },
    { 
      q: "¿Cuánto pesa cada tracker?", 
      a: "Solo 10 gramos. Ultra ligeros para máxima comodidad en sesiones largas." 
    },
    { 
      q: "¿Qué incluye cada paquete?", 
      a: "Trackers, straps elásticos premium, dongle NRF52840, cable USB-C y guía digital." 
    },
    { 
      q: "¿Tienen soporte técnico?", 
      a: "Sí, soporte 24/7 vía Discord. Respondemos en español siempre." 
    },
    { 
      q: "¿Hacen envíos internacionales?", 
      a: "Sí, envíos a México en 1-2 días, internacionales en 5-7 días hábiles. Todos incluyen tracking." 
    },
    { 
    ...
    { 
      ...
      a: "Sí, ofrecemos Blanco, Negro y Rojo Juaniconn. Para configuraciones especiales, contáctanos en Discord." 
    },
  ];
      ...
      <div className="pt-32 pb-20 px-4">
        <div className="container mx-auto max-w-3xl">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, i) => (
                ...
                >
                  ...
                  <div className="relative bg-card rounded-xl border border-border/50 data-[state=open]:border-mint/50 transition-all duration-300">
          ...
          <div className="mt-16 text-center animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <p className="text-muted-foreground mb-6">¿No encontraste tu respuesta?</p>
            <a 
