      ...
      <div className="pt-32 pb-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="text-center mb-16 animate-fade-in">
            <span className="text-sm font-semibold text-primary tracking-widest uppercase mb-4 block">Políticas</span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display mb-6">
              GARANTÍA Y <span className="bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent">DEVOLUCIONES</span>
            </h1>
          </div>
            ...
            <div className="relative p-8 rounded-2xl bg-card border border-border/50 overflow-hidden">
              ...
              <div className="relative">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-display">Garantía</h2>
                </div>
            ...
            <div className="relative p-8 rounded-2xl bg-card border border-border/50 overflow-hidden">
              ...
              <div className="relative">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-display">Devoluciones</h2>
                </div>
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
            ...
            <div className="relative p-8 rounded-2xl bg-card border border-border/50 overflow-hidden">
              ...
              <div className="relative">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-display">Proceso</h2>
                </div>
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
