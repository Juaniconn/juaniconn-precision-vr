...
import { MessageCircle, Users, Sparkles, Clock, Heart } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16 animate-fade-in">
              <div className="inline-flex items-center gap-2 bg-secondary/20 border border-secondary/30 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-medium text-secondary">Comunidad</span>
              </div>
            ...
            {/* Main Discord Card */}
            <div 
              className="relative bg-card border border-border rounded-3xl p-8 md:p-12 mb-12 animate-fade-in overflow-hidden group hover:border-secondary/50 transition-all duration-500"
            ...
            >
              ...
              <div className="relative z-10 text-center">
                <div className="inline-flex items-center justify-center w-24 h-24 bg-secondary/20 rounded-2xl mb-8 group-hover:scale-110 transition-transform duration-500">
                ...
                <Button
                  asChild
                  size="lg"
                  className="bg-secondary hover:bg-secondary/90 text-secondary-foreground px-10 py-6 text-lg font-display font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  <a
            ...
            <div className="grid md:grid-cols-3 gap-6 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="bg-card border border-border rounded-2xl p-6 hover:border-secondary/50 transition-all duration-500 group">
                <div className="p-3 bg-secondary/20 rounded-xl w-fit mb-4 group-hover:scale-110 transition-transform duration-300">
                  <Users className="h-6 w-6 text-secondary" />
                </div>
                <h3 className="font-display font-bold text-xl mb-2 text-foreground">Comunidad Activa</h3>
              ...
              <div className="bg-card border border-border rounded-2xl p-6 hover:border-secondary/50 transition-all duration-500 group">
                ...
                <h3 className="font-display font-bold text-xl mb-2 text-foreground">Soporte 24/7</h3>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="bg-card border border-border rounded-2xl p-6 hover:border-secondary/50 transition-all duration-500 group">
                ...
                <h3 className="font-display font-bold text-xl mb-2 text-foreground">Novedades</h3>
                <p className="text-muted-foreground text-sm">
